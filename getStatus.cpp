/*
 * getStatus.cpp: DNMP command-line client to get status of nfd
 *
 ...
 *   getStatus -p probe_name -a probe_arguments -t target
 *             -c count -i interval 
...
/*
 * Main for a generic Client that passes probe type and arguments
